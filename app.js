...
var budgetController = (function() {
    ...
    var Expense = function(id, descpription, value) {
        this.id = id;
    ...
    // to calculate the % of each expense
    ...
    return {
      getInput: function() {
        ...
        addListItem: function(obj, type) {
            ...
            // replace the placeholde with some actual data
...
var controller = (function(budgetCtrl, UICtrl ) {
    ...
    var ctrlAddItem = function() {
        ...
        if (input.description !== '' && !isNaN(input.value) && input.value > 0) {  // check for data in the in DOM
